...
export const guildDB = new Keyv(sqliteStore, {namespace: "settings"});
export const globalDB = new Keyv(sqliteStore, {namespace: "global"});
export const selfrolesDB = new Keyv(sqliteStore, {namespace: "selfroles"});
export const voicetextDB = new Keyv(sqliteStore, {namespace: "voicetext"});
export const statsDB = new Keyv(sqliteStore, {namespace: "stats"});
