/**
 * This file contains utilities for constructing URLs for BetterDiscord's website and API.
 * This comes from the original BetterDiscord source code https://github.com/BetterDiscord/BetterDiscord/blob/development/src/betterdiscord/data/web.ts
 */
...
export default class Web {
    ...
    static resources = {
        EMPTY_THUMBNAIL: EMPTY_USE_STORE ? "/resources/store/missing.svg" : "/resources/branding/invitebanner.png",
        /** @param {? string} thumbnail */
        thumbnail: (thumbnail?: string) => thumbnail ? join(thumbnail) : `https://docs.betterdiscord.app/branding/missing.png`
    };
